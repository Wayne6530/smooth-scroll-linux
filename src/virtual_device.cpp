...
bool VirtualDevice::create(const DeviceCapabilities& capabilities)
{
...

  {
    ...
    // libinput skips hardware wheel debouncing for virtual devices, preserving
    // the small high-resolution increments generated by the smoother.
    descriptor.id.bustype = BUS_VIRTUAL;
