...
const Nav = (() => {
  ...
  const PAGES = [
    { id: 'feature',    href: 'feature.html',    labelKey: 'nav.feature' },
    { id: 'quickstart', href: 'quickstart.html', labelKey: 'nav.quickstart' },
    { id: 'config',     href: 'index.html',      labelKey: 'nav.config' },
  ...
  function render(containerId) {
    ...
    title.textContent = 'Smooth Scroll';
  ...
  function getCurrentPageId() {
    ...
    if (filename === 'index' || filename === 'config') return 'config';
    return filename;
  }
